...
export class CharacterSprite {
    ...
    playAttack() {
        return new Promise(resolve => {
            ...
            gsap.killTweensOf(this.body);
            const tl = gsap.timeline({ onComplete: () => { this.playIdle(); resolve(); } });
    ...
    playHeal() {
        return new Promise(resolve => {
            ...
            this.container.addChild(flash);
            gsap.to(flash, { alpha: 0, duration: 0.6, onComplete: () => { flash.destroy(); resolve(); } });
        });
    }
    ...
    playShield() {
        return new Promise(resolve => {
            ...
            gsap.to(shield, { alpha: 0, duration: 0.8, delay: 0.5, onComplete: () => { shield.destroy(); resolve(); } });
        });
    }
    ...
    playSkillCast() {
        return new Promise(resolve => {
            ...
            gsap.to(glow, { alpha: 0, duration: 0.6, onComplete: () => { glow.destroy(); resolve(); } });
        });
    }
